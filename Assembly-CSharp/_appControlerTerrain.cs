...
{
	// Token: 0x060021BE RID: 8638 RVA: 0x000169FB File Offset: 0x00014BFB
	private void Awake()
	{
		this.GetLODManager();
	...
	// Token: 0x060021BF RID: 8639 RVA: 0x000FF0B0 File Offset: 0x000FD2B0
	private void Update()
	{
	...
	// Token: 0x060021C0 RID: 8640 RVA: 0x000FF1A4 File Offset: 0x000FD3A4
	...
	// Token: 0x060021C1 RID: 8641 RVA: 0x000FF1E4 File Offset: 0x000FD3E4
	private void OnGUI()
	{
		if (!this.LODmanager)
		{
